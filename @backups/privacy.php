    ...
    <body id="privacy">
        ...
        <section class="cid-rSSj4L1o7Y mbr-fullscreen mbr-parallax-background" id="header2-0">
            ...
            <div class="container align-center">
                ...
                <p>
                    <br>
                    This privacy policy sets out how this website (called: Awebgo) uses and protects any information that you give when you use this website.
                    <br>
                    <br>
                    The website “Awebgo” is committed to ensuring that your privacy is protected. Should we ask you to provide certain information by which you can be identified when using this website, then you can be assured that it will only be used in accordance with this privacy statement.
                    <br>
                    <br>
                    This website may change this policy from time to time by updating this page. You should check this page from time to time to ensure that you are happy with any changes. This policy is effective from: October 2015
                    <br>
                    <br>
                    What we collect
                    <br>
