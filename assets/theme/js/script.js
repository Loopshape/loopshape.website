...
( function($) {
	...
	$(document).ready(function() {
		...
		$("html body#index #space").click('bind', function(e) {
			$( "#target" ).keyup();
			$('input#commandline').focus().css('background-color', 'rgba(180,255,180,.7)').on('blur', function() {
        ...
        const floatField = document.getElementById('#commandline');
		const floatContainer = document.getElementById('#commandline');
		
		keycode = false;
		$('input#commandline').focus().on('change', function(event) {
            if(event.which == 13){
